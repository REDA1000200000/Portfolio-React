...
import myImage from './../assets/coder.png';
            ...
            <div className="flex flex-col sm:flex-row sm:items-center pt-0 justify-center w-full min-h-[58vh] tm:min-h-min tm:w-full sm:min-h-min sm:w-full sm:pt-0 tm:pt-0">
                <div className="flex flex-col justify-center sm:w-[70%] w-full sm:mr-5">
                    ...
                    <blockquote className="font-[800] text-[2rem] text-[#ec6e59;] mt-[-10px] lg:text-[2.4rem] md:text-[2rem] tm:text-[2.5rem] sm:text-[1rem]">
                        ...
                        <span className="before:block mx-4 mb-6 mt-4 before:absolute before:-inset-2 before:-skew-y-[3deg] before:bg-[#ec6e59;] relative inline-block">
                            <span className="relative text-[#fffffff0] dark:text-[#20262E]">Reda</span>
                            <span className="relative text-[#fffffff0] dark:text-[#20262E]">boujaaba</span>
                        </span>
                    </blockquote>
                    ...
                    I am passionate about building websites. With a degree in full-stack developper from EFET, I have honed my technical skills through diverse projects, both individually and in teams. 

                    I have built end-to-end web and websites using technologies such as HTML, JavaScript, CSS, PHP, Bootstrap, MySQL.
                    </p>
                ...
                <div className="flex place-content-center mt-7 ">
                        <div className="flex flex-row sm:flex-col gap-4">
                            <a rel="noreferrer" href="https://github.com/REDA1000200000" target="_blank">
